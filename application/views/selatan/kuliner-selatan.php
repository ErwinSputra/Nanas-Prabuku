        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/kselatan')?>"><span>Kuliner</span></a>   
                    </li>   
                </ul>
            </div>
        </nav>
                ...
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('selatan/rodabaru')?>"><img src="<?php echo base_url(); ?>assets/image/selatan/rodabaru.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('selatan/rodabaru')?>"><div class="name"><h4>RM Roda Baru</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('selatan/salerominang')?>"><img src="<?php echo base_url(); ?>assets/image/selatan/salerominang.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('selatan/salerominang')?>"><div class="name"><h4>RM Salero Minang</h4></div></a>
                        </div>
                    </div>
                </div>
            </div> 
