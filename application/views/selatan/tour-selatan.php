        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo site_url('menu/eduselatan')?>"><span>Pendidikan</span></a>   
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/wselatan')?>"><span>Pariwisata</span></a>   
                    </li>
                    <li class="menu-item">
                ...
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('selatan/caroline')?>"><img src="<?php echo base_url(); ?>assets/image/selatan/caroline.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('selatan/caroline')?>"><div class="name"><h4>Water Boom Caroline Island</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('selatan/kolamleny')?>"><img src="<?php echo base_url(); ?>assets/image/selatan/kolamleny.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('selatan/kolamleny')?>"><div class="name"><h4>Kolam Renang Leny Tirta</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
