        ...
        <br>
            <div class="sec-Section_Inner">
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('selatan/sd51')?>"><img src="<?php echo base_url(); ?>assets/image/selatan/sd51.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('selatan/sd51')?>"><div class="name"><h4>SD Negeri 51 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('selatan/sd52')?>"><img src="<?php echo base_url(); ?>assets/image/selatan/sd52.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('selatan/sd52')?>"><div class="name"><h4>SD Negeri 52 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('selatan/sd64')?>"><img src="<?php echo base_url(); ?>assets/image/selatan/sd64.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('selatan/sd64')?>"><div class="name"><h4>SD Negeri 64 Prabumulih</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
