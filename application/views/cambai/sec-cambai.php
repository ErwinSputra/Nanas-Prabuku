        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo site_url('menu/educambai')?>"><span>Pendidikan</span></a>   
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo site_url('menu/hcambai')?>"><span>Kesehatan</span></a>   
                    </li>
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/scambai')?>"><span>Keamanan</span></a>   
                    </li>
                    <li class="menu-item">
                ...
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/polresprabu')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/polresprabu.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/polresprabu')?>"><div class="name fspace"><h4 class="vert-al">Polres Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/polsekcambai')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/polsek.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/polsekcambai')?>"><div class="name fspace"><h4 class="vert-al">Polsek Cambai</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/kantorpolsek')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/polsek.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/kantorpolsek')?>"><div class="name"><h4>Kantor Polsek Cambai</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
