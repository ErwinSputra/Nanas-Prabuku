        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/hcambai')?>"><span>Kesehatan</span></a>   
                    </li>
                    <li class="menu-item">
                ...
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/puskescambai')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/puskescambai.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/puskescambai')?>"><div class="name fspace"><h4 class="vert-al">Puskesmas Cambai</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/klinikananda')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/klinikananda.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/klinikananda')?>"><div class="name"><h4>Klinik 24 Jam Ananda Medika</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
