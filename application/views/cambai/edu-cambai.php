    ...
    <div>
        ...
        <br>
            <div class="sec-Section_Inner">
                ...
                <p class="wrap"><a class="more-info shadow-sm" href="<?php echo site_url('menu/educambai2') ?>">See More →</a></p>
            </div>
            ...
            <div class="sec-Section_Inner">
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/smp6')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/smp6.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/smp6')?>"><div class="name"><h4>SMP Negeri 06 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/smp10')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/smp10.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/smp10')?>"><div class="name"><h4>SMP Negeri 10 Prabumulih</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>    
            ...
            <div class="sec-Section_Inner">
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/sma6')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/sma6.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/sma6')?>"><div class="name"><h4>SMA Negeri 06 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/smk3')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/smk3.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/smk3')?>"><div class="name"><h4>SMK Negeri 03 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/masdas')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/masdas.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/masdas')?>"><div class="name fspace"><h4 class="vert-al">MAS Darussalam</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
