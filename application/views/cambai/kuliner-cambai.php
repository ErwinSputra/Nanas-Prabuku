        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/kcambai')?>"><span>Kuliner</span></a>   
                    </li>   
                </ul>
            </div>
        </nav>
                ...
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/rmombai')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/rmombai.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/rmombai')?>"><div class="name"><h4>RM Pindang Ombai</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('cambai/pindangaisyah')?>"><img src="<?php echo base_url(); ?>assets/image/cambai/pindangaisyah.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('cambai/pindangaisyah')?>"><div class="name"><h4>Pindang Aisyah</h4></div></a>
                        </div>
                    </div>
                </div>
            </div> 
