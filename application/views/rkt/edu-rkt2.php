        ...
        <br>
            <div class="sec-Section_Inner">
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('rkt/sd66')?>"><img src="<?php echo base_url(); ?>assets/image/rkt/sd66.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('rkt/sd66')?>"><div class="name"><h4>SD Negeri 66 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('rkt/sd67')?>"><img src="<?php echo base_url(); ?>assets/image/rkt/sd67.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('rkt/sd67')?>"><div class="name"><h4>SD Negeri 67 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('rkt/sd68')?>"><img src="<?php echo base_url(); ?>assets/image/rkt/sd68.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('rkt/sd68')?>"><div class="name"><h4>SD Negeri 68 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('rkt/sd78')?>"><img src="<?php echo base_url(); ?>assets/image/rkt/sd78.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('rkt/sd78')?>"><div class="name"><h4>SD Negeri 78 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('rkt/sd81')?>"><img src="<?php echo base_url(); ?>assets/image/rkt/sd81.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('rkt/sd81')?>"><div class="name"><h4>SD Negeri 81 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('rkt/sd83')?>"><img src="<?php echo base_url(); ?>assets/image/rkt/sd83.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('rkt/sd83')?>"><div class="name"><h4>SD Negeri 83 Prabumulih</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
