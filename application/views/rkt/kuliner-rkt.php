        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/krkt')?>"><span>Kuliner</span></a>   
                    </li>  
                </ul>
            </div>
        </nav>
                ...
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('rkt/rmkembar')?>"><img src="<?php echo base_url(); ?>assets/image/rkt/rmkembar.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('rkt/rmkembar')?>"><div class="name"><h4>Rumah Makan Kembar</h4></div></a>
                        </div>
                    </div>
                </div>
            </div> 
