        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/umutara')?>"><span>UMKM</span></a>   
                    </li>
                    <li class="menu-item">
                ...
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/pakarraya')?>"><img src="<?php echo base_url(); ?>assets/image/umkm.png" alt=""></a></div>
                            <a href="<?php echo site_url('utara/pakarraya')?>"><div class="name fspace"><h4 class="vert-al">Pakar Raya</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/banksampah')?>"><img src="<?php echo base_url(); ?>assets/image/utara/banksampah.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/banksampah')?>"><div class="name"><h4>Bank Sampah Kota Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/pusatoleholeh')?>"><img src="<?php echo base_url(); ?>assets/image/umkm2.png" alt=""></a></div>
                            <a href="<?php echo site_url('utara/pusatoleholeh')?>"><div class="name"><h4>Pusat Oleh-Oleh Khas Kota Prabumulih</h4></div></a>
                        </div>
                    </div>
                </div>
            </div> 
