        ...
        <br>
            <div class="sec-Section_Inner">
                ...
                <div class="col">
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd18')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd18.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd18')?>"><div class="name"><h4>SD Negeri 18 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd19')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd19.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd19')?>"><div class="name"><h4>SD Negeri 19 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd21')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd21.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/s21d')?>"><div class="name"><h4>SD Negeri 21 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd26')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd26.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd26')?>"><div class="name"><h4>SD Negeri 26 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd33')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd33.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd33')?>"><div class="name"><h4>SD Negeri 33 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd35')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd35.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd35')?>"><div class="name"><h4>SD Negeri 35 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd36')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd36.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd36')?>"><div class="name"><h4>SD Negeri 36 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd40')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd40.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd40')?>"><div class="name"><h4>SD Negeri 40 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd42')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd42.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd42')?>"><div class="name"><h4>SD Negeri 42 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd44')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd44.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd44')?>"><div class="name"><h4>SD Negeri 44 Prabumulih</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('utara/sd45')?>"><img src="<?php echo base_url(); ?>assets/image/utara/sd45.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('utara/sd45')?>"><div class="name"><h4>SD Negeri 45 Prabumulih</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
