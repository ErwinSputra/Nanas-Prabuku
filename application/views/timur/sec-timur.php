        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/stimur')?>"><span>Keamanan</span></a>   
                    </li>
                    <li class="menu-item">
            ...
            <div class="sec-Section_Inner">
                ...
                <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('timur/polsektimur')?>"><img src="<?php echo base_url(); ?>assets/image/timur/polsektimur.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('timur/polsektimur')?>"><div class="name"><h4>Polsek Prabumulih Timur</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
