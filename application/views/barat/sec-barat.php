...
<body>
    <div>
        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/sbarat')?>"><span>Keamanan</span></a>   
                    </li>
                    <li class="menu-item">
        ...
        <h3 class="wrap text-center sub-title shadow-sm">Polsek</h3>
        <br>
            <div class="sec-Section_Inner">
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('barat/polsekbarat')?>"><img src="<?php echo base_url(); ?>assets/image/barat/polsekbarat.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('barat/polsekbarat')?>"><div class="name"><h4>Polsek Prabumulih Barat</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
