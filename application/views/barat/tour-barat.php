        ...
        <nav class="nav-primary" id="genesis-nav-primary" aria-label="Main navigation">
            <div class="wrap" id="">
                <ul id="menu-primary-navigation" class="menu genesis-nav-menu menu-primary">
                    ...
                    <li class="menu-item">
                        <a class="active" href="<?php echo site_url('menu/wbarat')?>"><span>Pariwisata</span></a>   
                    </li>
                    <li class="menu-item">
                ...
                <div class="row row-cols-1 row-cols-md-3 text-center justify-content-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('barat/darus')?>"><img src="<?php echo base_url(); ?>assets/image/barat/darus.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('barat/darus')?>"><div class="name fspace"><h4 class="vert-al">Masjid Darussalam</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('barat/pakhaji')?>"><img src="<?php echo base_url(); ?>assets/image/barat/pakhaji.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('barat/pakhaji')?>"><div class="name fspace"><h4 class="vert-al">Kolam Pak Haji</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('barat/payuputat')?>"><img src="<?php echo base_url(); ?>assets/image/barat/payuputat.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('barat/payuputat')?>"><div class="name"><h4>Pantai Pasir Payuputat</h4></div></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div><a href="<?php echo site_url('barat/patraria')?>"><img src="<?php echo base_url(); ?>assets/image/barat/patraria.jpg" alt=""></a></div>
                            <a href="<?php echo site_url('barat/patraria')?>"><div class="name"><h4>Kolam Renang Patra Ria</h4></div></a>
                        </div>
                    </div>
                </div>
            </div>
